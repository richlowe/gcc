...
/* For the SPARC target, use RTL backend for function number from 
   ...
   a compilation unit has number 1. */

extern unsigned HOST_WIDE_INT first_rtl_backend;
extern unsigned HOST_WIDE_INT last_rtl_backend;
extern unsigned HOST_WIDE_INT current_function_number;

#ifdef __linux__
/* ir_function_count has the number of functions dumpped into IR */
extern unsigned HOST_WIDE_INT ir_function_count;
#endif

/* True if stabs/dwarf2 debugging information will be generated by dbg_gen.
   Ignored for other debugging formats.  */
extern bool flag_use_dbg_gen;

/* 0 - generate SunIR, don't use RTL backend
   1 - use RTL backend; stop IR gen for current function
  -1 - use RTL backend; stop IR gen for compilation unit */
extern HOST_WIDE_INT flag_use_rtl_backend;
...
extern unsigned HOST_WIDE_INT pagesize_stack;
extern unsigned HOST_WIDE_INT pagesize_heap;
