...
CONCAT3(__mul,MODE,3) (MTYPE a, MTYPE b, MTYPE c, MTYPE d)
{
  ...
  /* GCCFSS hack: make IR gen go into RTL mode, so complex multiply will be
     generated by RTL backend and support functions like _Q_cplx_mul
     won't bother libgcc.so during linking on Solaris 9 */
