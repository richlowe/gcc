...
// { dg-final { scan-assembler "gstruct_head_ordy_defn_ref_head.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_ref_head.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "gstruct_head_ordy_defn_ptr_head.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_ptr_head.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "gstruct_head_ordy_defn_fld_head.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_fld_head.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "gstruct_head_ordy_defn_var_head.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_var_head_inc.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_var_head_ref.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_var_head_ptr.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_var_head_fld.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "gstruct_head_ordy_decl_ref_head.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "gstruct_head_ordy_defn_ref_base.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_ref_base.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "gstruct_head_ordy_defn_ptr_base.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_ptr_base.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "gstruct_head_ordy_defn_fld_base.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_fld_base.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "gstruct_head_ordy_defn_var_base.*DW_AT_name" { xfail sparc*-*-* } } }
// { dg-final { scan-assembler "field_head_ordy_defn_var_base.*DW_AT_name" { xfail sparc*-*-* } } }
